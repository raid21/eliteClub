...
<head>
    ...
    <title>Edit Dentist | Elite</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 p-sm-1 p-lg-5 create shadow-lg rounded">
                        ...
                        <h4 class="text-center">Edit Dentist</h4>
                        ...
                        <form action="edit_dnts.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select id="drType" class="form-control" name="drType">
                                        <option selected value="dentists">Dentist</option>
                                </select>
                            </div>
                            
                            <button type="submit" name="update-Dentist" value="update-Dentist"  class="btn btn-primary">Update</button>
