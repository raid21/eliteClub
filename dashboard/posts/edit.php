                    ...
                    <div class="col-sm-12 p-sm-1 p-lg-5 create shadow-lg rounded">
                        ...
                        <form action="edit.php" method="POST" enctype="multipart/form-data" class="mb-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $act_date ?>" name="act_date" placeholder="Ex: june 7, 2020" id="act_date">
                            </div>

                            <div class="form-group">
                                <label for="act_time">Activity Date</label>
                                <input type="text" class="form-control" value="<?php echo $act_time ?>" name="act_time" placeholder="Ex: 7:00 AM" id="act_time">
                            </div>
